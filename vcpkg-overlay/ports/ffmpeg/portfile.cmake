...
set(MIN_OPTS "")
list(APPEND MIN_OPTS "--disable-all")
list(APPEND MIN_OPTS "--enable-avcodec --enable-avformat --enable-swresample")
list(APPEND MIN_OPTS "--enable-decoder=aac,mp3,opus,pcm_s16le,pcm_f32le")
list(APPEND MIN_OPTS "--enable-demuxer=flv,hls,mpegts,mov,mp4,wav,aac,mp3,ogg")
list(APPEND MIN_OPTS "--enable-protocol=http,https,tcp")
list(APPEND MIN_OPTS "--enable-parser=aac,mp3,opus")
list(APPEND MIN_OPTS "--enable-bsf=aac_adtstoasc")
foreach(f ${MIN_OPTS})
    string(APPEND OPTIONS " ${f}")
endforeach()
message(STATUS "Minimized Options: ${MIN_OPTS}")
# ======================================================================
