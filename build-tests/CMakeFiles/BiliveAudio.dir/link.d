BiliveAudio: \
  ...
  /usr/lib/x86_64-linux-gnu/libQt6WebSockets.so.6.10.2 \
  ...
  /usr/lib/x86_64-linux-gnu/libavfilter.so.11 \
  /usr/lib/x86_64-linux-gnu/libavformat.so.62 \
  /usr/lib/x86_64-linux-gnu/libavutil.so.60 \
  /usr/lib/x86_64-linux-gnu/libplacebo.so.360 \
  ...
  /usr/lib/x86_64-linux-gnu/libavdevice.so.62 \
  /usr/lib/x86_64-linux-gnu/libbluray.so.3 \
  /usr/lib/x86_64-linux-gnu/liblua5.2.so.0 \
  /usr/lib/x86_64-linux-gnu/librubberband.so.3 \
  ...
  /usr/lib/x86_64-linux-gnu/libunibreak.so.6 \
